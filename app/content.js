...
window.QUIZ_CONTENT = {
  ...
  flow: [
    ...
    // HTML-Infografik (Design: Leo, Claude Design 2026-07-03) statt Bild — responsive.
    { type: "education", variant: "info", id: "eduSchaltzentrale",
      ...
      infographic: {
        variant: "hub",
        title: "Die Schaltzentrale des Körpers",
        sub: "Wenige Zentimeter groß und überall beteiligt",
        items: [
          { icon: "bolt",    title: "Energie",         sub: "Antrieb & Stoffwechsel" },
          { icon: "thermo",  title: "Temperatur",      sub: "Frieren oder Schwitzen" },
          { icon: "heart",   title: "Herzschlag",      sub: "Puls & Kreislauf" },
          { icon: "drop",    title: "Verdauung",       sub: "Tempo im Darm" },
          { icon: "strands", title: "Haut & Haare",    sub: "Struktur & Wachstum" },
          { icon: "brain",   title: "Stimmung & Fokus", sub: "Kopf & Gefühl" },
        ],
        foot: "Arbeitet sie langsamer, zeigt sich das oft an mehreren Stellen gleichzeitig.",
      },
      cta: "Weiter" },
    ...
    { type: "education", variant: "info", id: "eduHormone",
      ...
      infographic: {
        variant: "venn",
        title: "Wechseljahre oder Schilddrüse?",
        sub: "Viele Beschwerden ähneln sich stark",
        left: "Wechseljahre<br>& Hormone",
        right: "Schilddrüsen-<br>unterfunktion",
        centerLabel: "Beides möglich",
        chips: ["Müdigkeit", "Gewichts&shy;veränderung", "Stimmungstiefs", "veränderter Zyklus"],
        foot: "Beides im Blick behalten, statt vorschnell einzuordnen.",
      },
      cta: "Weiter" },
    ...
    { type: "education", variant: "info", id: "eduHashimoto",
      ...
      infographic: {
        variant: "cards",
        title: "Hashimoto, kurz erklärt",
        cards: [
          { icon: "gland",       title: "Autoimmun-Reaktion", text: "Das Immunsystem richtet sich gegen die eigene Schilddrüse." },
          { badge: "Nr.&thinsp;1", title: "Häufigste Ursache",  text: "Die meisten Schilddrüsen&shy;unterfunktionen in Deutschland entstehen so." },
          { icon: "family",      title: "Familiär gehäuft",   text: "Fälle in der Familie können dein eigenes Risiko erhöhen." },
        ],
        foot: "Kein Grund zur Sorge, aber ein guter Grund, aufmerksam zu sein.",
      },
      cta: "Weiter" },
    ...
    { type: "education", variant: "info", id: "eduTsh",
      ...
      infographic: {
        variant: "compare",
        title: "TSH allein ist nicht das ganze Bild",
        left: {
          big: "TSH",
          badge: "Wird meist gemessen",
          points: ["kann im Normbereich liegen …", "… obwohl die Schilddrüse noch nicht rund läuft"],
        },
        arrowLabel: "ergänzt um<br>weitere Werte",
        right: {
          big: "fT4 · fT3 · TPO-AK",
          badge: "Das vollständigere Bild",
          points: ["fT4 & fT3: die eigentlichen Hormone", "TPO-Antikörper: Hinweis auf Hashimoto"],
        },
        foot: "Gut zu wissen fürs nächste Arztgespräch.",
      },
      cta: "Weiter" },
